...
export type NavigationItem = Readonly<{ id: NavigationItemId; parentId?: NavigationItemId; kind: NavigationItemKind; level: NavigationLevel; label: string; lifecycleStage?: Exclude<import("../routing/platform-route-definition").HpmStage, "home">; href?: string; icon?: NavigationIcon; group: NavigationGroupId; experience: PlatformExperience; requiredCapabilities?: readonly CapabilityId[]; requiredEntitlements?: readonly string[]; availability: NavigationAvailability; activeMatch?: NavigationActiveMatch; description?: string; badge?: NavigationBadgeDefinition; featureFlag?: string; setupRequirement?: string; mobilePriority?: number }>;
