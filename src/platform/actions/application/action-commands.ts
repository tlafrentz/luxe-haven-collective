...
export type SubmitActionForReviewCommand = ActionCommandContext;
export type ReturnActionForCorrectionCommand = ActionCommandContext & Readonly<{ reason: string }>;
export type CompleteActionCommand = ActionCommandContext;
export type FailActionCommand = ActionCommandContext & Readonly<{ reason: string }>;
export type RetryActionCommand = ActionCommandContext & Readonly<{ reason: string }>;
export type ReopenActionCommand = ActionCommandContext & Readonly<{ reason: string }>;
