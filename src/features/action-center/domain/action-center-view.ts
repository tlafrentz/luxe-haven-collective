...
export type ActionCenterCommand = "commit" | "mark-ready" | "assign" | "claim" | "release" | "schedule" | "start" | "block" | "unblock" | "submit-for-review" | "return-for-correction" | "complete" | "fail" | "retry" | "reopen" | "cancel" | "archive" | "change-priority" | "change-owner" | "link-outcome";
