...
export function ActionCenter({ view, selectedView, plans = [] }: { view: ActionCenterView; selectedView: ActionCenterViewSelection; plans?: readonly ActionPlanProps[] }) {
  ...
  return <main className="px-4 py-8 sm:px-6 lg:px-8 lg:py-10"><div className="mx-auto max-w-[1480px] space-y-8">
    ...
    {selectedView === "plans" ? <ActionPlanQueue plans={plans} /> : <ActionQueue actions={actions} selectedView={selectedView} />}
  </div></main>;
}
