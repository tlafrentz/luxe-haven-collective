...
import { autosaveDelay, compatibleComponents, guidebookHealth } from "./domain";
...
describe("guidebook builder",()=>{
  ...
  it("autosaves dirty changes at thirty seconds",()=>expect(autosaveDelay(true)).toBe(30_000));
});
