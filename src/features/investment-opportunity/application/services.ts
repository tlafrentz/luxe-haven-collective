...
export type SaveOpportunityAnalysisInput = Readonly<{ lifecycleResult: InvestmentLifecycleResult; lifecycleResultId: string; sourceSummary: OpportunityAnalysisSourceSummary; policyVersions?: Omit<OpportunityAnalysisPolicyVersions, "opportunitySnapshotSchema">; lineage?: Omit<OpportunityAnalysisLineage, "investmentLifecycleResultId" | "evidenceIds">; analyzedAt: Date }>;
