...
export type OpportunityAnalysisLineage = Readonly<{ investmentLifecycleResultId: string; sourceAnalysisVersionId?: string; investmentAnalysisContextId?: string; investmentMarketContextId?: string; marketAnalysisReportId?: string; subjectPropertySnapshotId?: string; marketSnapshotId?: string; assumptionVersion?: string; confidenceVersion?: string; comparablePolicyVersion?: string; evidenceIds: readonly string[]; decisionId?: string; recommendationId?: string }>;
