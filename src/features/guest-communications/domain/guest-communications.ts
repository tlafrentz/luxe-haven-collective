...
export type CommunicationTemplate = Readonly<{id:string;category:"booking-confirmation"|"pre-arrival"|"check-in"|"parking"|"wifi"|"house-rules"|"maintenance"|"first-night"|"checkout-reminder"|"review-request"|"issue-acknowledgement"|"general-reply"|"emergency"|"thank-you";title:string;body:string;variables:readonly TemplateVariable[];status:"active"|"inactive"|"archived"}>;
export type TemplateVariable = "guestName"|"propertyName"|"arrival"|"departure"|"guidebookLink"|"checkInTime"|"checkoutTime"|"doorCode"|"wifi"|"parkingInstructions"|"hostName";
