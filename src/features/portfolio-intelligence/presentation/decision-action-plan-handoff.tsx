...
import { actionPlanPath } from "@/features/action-center/domain/action-plan-route";

export function DecisionActionPlanHandoff({ decisionId }: Readonly<{ decisionId: string }>) {
  const [pending, startTransition] = useTransition();
  const [result, setResult] = useState<Readonly<{ ok: boolean; message?: string; planId?: string;workspaceId?:string }> | null>(null);
