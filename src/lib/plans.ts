...
export const plans: Plan[] = [
  {
    ...
    implementation: "Expected setup is 1–2 business days after a qualifying data connection.",
    support: "Standard email support with a two-business-day response target.",
  },
  {
    slug: "professional",
    name: "Growth",
    tagline: "For growing operators managing up to three base properties.",
    ...
    whoItsFor: [
      "Operators managing up to 3 base properties",
      "Teams ready to move from spreadsheets to one system",
    ],
    implementation: "Expected setup is 1–2 business days after a qualifying data connection.",
    support: "Priority email support with a one-business-day response target.",
  },
  {
    slug: "portfolio",
    name: "Portfolio",
    tagline: "Deferred custom portfolio offer.",
    bestFor: "Future custom portfolio engagements",
    monthlyPrice: null,
    ...
    implementation: "Not available for purchase.",
    support: "Not defined until separate approval.",
  },
  {
    slug: "enterprise",
    name: "Enterprise",
