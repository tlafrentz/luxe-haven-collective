...
const lenses = {
  observe: [
    {
      ...
      href: "/dashboard/observe/revenue",
      capability: "revenue",
    },
    {
      label: "Financial Intelligence",
      href: "/dashboard/observe/financial",
  ...
  understand: [
    ...
    },
    {
      ...
      href: "/dashboard/understand/portfolio",
...
export function IntelligenceWorkspaceHeader({
  ...
  const description =
    stage === "observe"
      ...
      : "Gain clarity on why performance is happening and what matters most.";
  return (
    <header className="mx-auto max-w-[1500px] px-4 pb-3 pt-6 sm:px-6 lg:px-8">
      <p
        className={[
          "text-[11px] font-bold uppercase tracking-[0.12em]",
          stage === "observe" ? "text-emerald-700" : "text-violet-700",
        ].join(" ")}
      >
      ...
      <div className="mt-5 flex items-start justify-between gap-4">
        <nav
          aria-label={`${title} intelligence lenses`}
          ...
          {lenses[stage].map((lens, index) => {
            ...
            return (
              <ContextLink
                ...
                onClick={() =>
                  recordPlatformNavigationEvent(`${stage}_lens_selected`, {
                    lens: lens.capability,
                    destinationRoute: lens.href,
                  })
                }
                className={[
                  "inline-flex min-h-10 min-w-44 shrink-0 items-center justify-center gap-2 rounded-md border px-4 text-xs font-semibold outline-none transition-colors focus-visible:ring-2 focus-visible:ring-offset-2",
                  active
                    ? stage === "observe"
...
export function WorkspaceLocalNavigation({
  ...
  return (
    <div className="bg-transparent">
      <nav
        aria-label={label}
        className="mx-auto flex max-w-[1500px] gap-7 overflow-x-auto border-b border-stone-200 px-4 sm:px-6 lg:px-8"
      >
        {items.map((item) => {
          ...
          return (
            <ContextLink
              ...
              aria-current={active ? "page" : undefined}
              className={[
                "min-h-10 shrink-0 border-b-2 py-3 text-xs font-semibold outline-none focus-visible:ring-2 focus-visible:ring-teal-600",
                active
