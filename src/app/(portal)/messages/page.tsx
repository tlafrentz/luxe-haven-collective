  ...
  return (
    <WorkspacePage width="wide">
      <WorkspaceHeader
        ...
        actions={
        <button type="button" className="inline-flex items-center justify-center gap-2 self-start rounded-full bg-stone-950 px-5 py-2.5 text-sm font-semibold text-white outline-none hover:bg-stone-800 focus-visible:ring-2 focus-visible:ring-teal-600 focus-visible:ring-offset-2">
