...
export default function FinancialLensLayout({ children }: { children: React.ReactNode }) { return <><WorkspaceLocalNavigation label="Financial Intelligence views" items={items} />{children}</>; }
