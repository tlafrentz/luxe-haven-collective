...
export default function InvestmentOpportunityWorkspaceLoading() {
  return <main aria-busy="true" aria-label="Loading investment opportunity workspace" className="mx-auto max-w-7xl space-y-8 px-4 py-8 sm:px-6 lg:px-8 lg:py-10">
    ...
    <section aria-label="Loading current objective"><SkeletonCard rows={2} wide /></section>
    <section aria-label="Loading acquisition lifecycle"><SkeletonCard rows={4} wide /></section>
    <section aria-label="Loading lifecycle guidance" className="grid gap-5 xl:grid-cols-2"><SkeletonCard rows={3} /><SkeletonCard rows={3} /></section>
    <section aria-label="Loading blockers and warnings" className="grid gap-5 lg:grid-cols-2"><SkeletonCard rows={2} /><SkeletonCard rows={2} /></section>
