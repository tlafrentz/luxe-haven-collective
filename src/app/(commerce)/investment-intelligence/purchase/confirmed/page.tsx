...
export const metadata: Metadata = {
  ...
  description: "Your Investment Intelligence order has been confirmed.",
};

export default async function InvestmentPurchaseConfirmedPage({
  searchParams,
}: {
      ...
      <div className="container-shell py-16">
        <div className="mx-auto max-w-xl rounded-2xl border border-[#dce2dd] bg-white p-10 text-center">
          ...
          <p className="mt-3 text-sm text-stone-600">
            {paid
              ? "Your Investment Intelligence order has been confirmed."
          ...
          <Link
            href={`/dashboard/investments/new?welcome=1${result?.productName ? `&package=${encodeURIComponent(result.productName)}` : ""}`}
