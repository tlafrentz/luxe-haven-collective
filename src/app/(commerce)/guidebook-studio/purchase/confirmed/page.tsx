...
export const metadata: Metadata = {
  ...
  description: "Your Guidebook Studio order has been confirmed.",
};
      ...
      <div className="container-shell py-16">
        <div className="mx-auto max-w-xl rounded-2xl border border-[#dce2dd] bg-white p-10 text-center">
          ...
          <p className="mt-3 text-sm text-stone-600">
            {paid
              ? "Your Guidebook Studio order has been confirmed."
          ...
          {result ? (
            <dl className="mt-8 rounded-xl bg-stone-50 p-5 text-left">
              ...
              <dt className="mt-4 text-xs uppercase tracking-wider text-stone-500">Package</dt>
