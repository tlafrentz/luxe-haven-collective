...
do $$ begin
  perform public.accept_workspace_invitation('ae000002-0000-4000-8000-000000000001','controlled-token','accept-command-wrong');
  raise exception 'AUTH_EMAIL_WRONG_RECIPIENT_ACCEPTED';
exception when sqlstate '42501' then null; end $$;

-- Intended consumption creates exactly one authorized owner membership and consumes the token atomically.
select set_config('request.jwt.claim.sub','ae000001-0000-4000-8000-000000000003',true);
select public.accept_workspace_invitation('ae000002-0000-4000-8000-000000000001','controlled-token','accept-command-0001');
do $$ begin
...
-- Token replay cannot create another membership or mutate the accepted invitation.
do $$ begin
  perform public.accept_workspace_invitation('ae000002-0000-4000-8000-000000000001','controlled-token','accept-command-replay');
  raise exception 'AUTH_EMAIL_TOKEN_REPLAY_ALLOWED';
exception when sqlstate '42501' then null; end $$;
do $$ begin
