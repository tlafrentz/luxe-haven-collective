...
const migration = readFileSync("supabase/migrations/20260824001000_ps001d_certification_controls.sql", "utf8");
...
const ready = () => ({ expected: binding, deployed: binding, aliasDeploymentId: binding.deploymentId, migrationParity: true, requiredConfigurationPresent: true, fs008AndCatalogUnchanged: true, claimAvailable: true, ledgerAvailable: true, cleanupAvailable: true, activeClaimConflict: false, authorizations, now });
